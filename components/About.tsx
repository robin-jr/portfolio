...
function About() {
    return (
        <div className="lg:flex md:w-[80%] justify-center">
            <div className="flex flex-col flex-1 mr-10 items-center">
                <div className="relative">
                    <img src={"/robin-color.jpg"} className="w-[20em] lg:w-[30em] mb-10"></img>
                    <img src={"/robin-grey.jpg"} className="w-[20em] lg:w-[30em] mb-10 transition-all duration-700 absolute top-0 hover:opacity-0"></img>
                </div>
